...
class Trainer:
    ...
    def fit(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            for batch_index in batches_indices:
                loss = self.model.compute_loss_and_gradients(self.dataset.train_X[batch_index],
                                                      self.dataset.train_y[batch_index])
            ...
            print("E: %d, Loss: %f, Train accuracy: %f, val accuracy: %f" %
