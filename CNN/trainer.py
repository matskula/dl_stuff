...
class Trainer:
    ...
    def __init__(self, model, dataset, optim,
        ...
        :param dataset: instance of Dataset class - data to train on
        :param optim: optimization method (see optim.py)
        :param num_epochs: int - number of epochs to train
        :param batch_size: int - batch size
        :param learning_rate: float - initial learning rate
        :param learning_rate_decay:float - ratio for decaying learning rate every epoch
        """
